...
export const metadata: Metadata = {
  title: `About`,
  description:
    "Learn about useagents's mission to make AI development more accessible.",
};
  ...
  return (
    <FadeInOutWrapper className="container max-w-3xl mx-auto px-6 lg:py-12 py-24  md:mt-24  pb-32">
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        <h1 className="lg:text-4xl md:text-3xl text-2xl  text-center font-heading  lg:mb-20 mb-10">
          Why we built useagents
        </h1>
        ...
        <div className="space-y-6 text-muted-foreground">
          <p className=" leading-relaxed">
            ...
            the right tools. useagents fixes that by curating the best AI dev
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              prototyping an agent or scaling to production, useagents helps you
          ...
          <section>
            ...
            <p className="leading-relaxed">
              useagents is built by AI builders, for AI builders. Contribute a
              tool, share feedback, or help us discover the next big thing in
              the AI dev world.
            </p>
          </section>
